...
## 2 foreground IDs for the selected DECOY bin
...
## try another tool for reactome (enrichR?)

write.table(foreground_entrez_ids, file = "../out/medium_bins/foreground_entrez_ids.tsv", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)


write.table(background_entrez_ids, file = "../out/medium_bins/background_entrez_ids.tsv", sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
