...
# the below were already loaded in the environment from running the pathway enrichment analysis
...
write.table(protein_ids_df, "../out/protein_ids_for_FASTA_download.tsv", 
            sep = "\t", row.names = FALSE, col.names = TRUE)




# we run a powerSHell script to collect the associated FASTA sequences from the web
# the script is get_FASTA_files.ps1

#### code below did not quite work so i used power shell 
