...
### need some plots to visualise the erichment - barplots? histogram of bins?

### need some statistical test to see if actually significantly more?
```
...
# Save as a TSV file
write.table(tyrosines_containing_foreground, file = paste0(project_dir,"out/medium_bins/mz_-0.013_-0.007_tyrosine_containing_foreground.tsv"), sep = "\t", row.names =  FALSE, col.names = TRUE, quote = FALSE)
...
write.table(tyrosines_containing_foreground_inSwissProt, file = "../out/medium_bins/tyrosine_containing_foreground_inSwissProt.tsv", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
...
write.table(tyrosines_containing_foreground_UNMATCHED, file = "../out/medium_bins/tyrosine_containing_foreground_UNMATCHED.tsv", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
...
# Then write the data frame to a file
write.table(tyrosines_containing_background_inSwissProt, file = "../out/medium_bins/tyrosine_containing_background_inSwissProt.tsv", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
...
write.table(tyrosines_containing_background_UNMATCHED, file = "../out/medium_bins/tyrosine_containing_background_UNMATCHED.tsv", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
...
ggsave("../out/medium_bins/KEGG_dotplot_bw.png", plot = last_plot(), width = 6, height = 4, dpi = 300)
