...
# Save as a TSV file
write.table(tyrosines_containing_foreground, file = paste0(project_dir,"out/mz_0.0075_0.0125_tyrosine_containing_foreground_DECOY1.tsv"), sep = "\t", row.names =  FALSE, col.names = TRUE, quote = FALSE)
...
write.table(tyrosines_containing_foreground_inSwissProt, file = "../out/tyrosine_containing_DECOY1_inSwissProt.tsv", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
...
write.table(tyrosines_containing_foreground_UNMATCHED, file = "../out/tyrosine_containing_DECOY1_UNMATCHED.tsv", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
...
max(GO_term_dataframe_MF$qvalue)
# [1] 0..4308452 - retrospectively set to that
...
max(GO_term_dataframe_CC$qvalue) #[1] 0.4744984
