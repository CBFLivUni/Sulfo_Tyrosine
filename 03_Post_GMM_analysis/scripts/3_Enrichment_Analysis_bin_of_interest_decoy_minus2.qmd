...
bin_of_interest <- cleaned_postGMM_data[["mz_-0.0225_-0.0175"]]
...
# Save as a TSV file
write.table(tyrosines_containing_foreground, file = paste0(project_dir,"out/mz_-0.0225_-0.0175_tyrosine_containing_foreground_DECOY_minus2.tsv"), sep = "\t", row.names =  FALSE, col.names = TRUE, quote = FALSE)
...
write.table(tyrosines_containing_foreground_inSwissProt, file = "../out/tyrosine_containing_DECOY_minus2_inSwissProt.tsv", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
...
write.table(tyrosines_containing_foreground_UNMATCHED, file = "../out/tyrosine_containing_DECOY_minus2_UNMATCHED.tsv", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
...
max(GO_term_dataframe_MF$qvalue)
# [1] 0.3744183retrospectively set to that
