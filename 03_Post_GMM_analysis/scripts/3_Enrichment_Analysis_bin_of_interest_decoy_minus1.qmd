...
# Save as a TSV file
write.table(tyrosines_containing_foreground, file = paste0(project_dir,"out/mz_-0.0175_-0.0125_tyrosine_containing_foreground_DECOY_minus1.tsv"), sep = "\t", row.names =  FALSE, col.names = TRUE, quote = FALSE)
...
write.table(tyrosines_containing_foreground_inSwissProt, file = "../out/tyrosine_containing_DECOY_minus1_inSwissProt.tsv", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
...
write.table(tyrosines_containing_foreground_UNMATCHED, file = "../out/tyrosine_containing_DECOY_minus1_UNMATCHED.tsv", sep = "\t", row.names = FALSE, col.names = TRUE, quote = FALSE)
