# Start PDF device
pdf("../out/EnrichmentPlots_DECOY1_abithacky.pdf", width=8.27, height=11.69)

# "Title PAGE"
plot(1, type="n", xlab="", ylab="", xlim=c(0, 1), ylim=c(0, 1))
text(0.5, 0.5, "GO Molecular Function, DECOY1", cex = 2.5) 
...
# "Title PAGE"
plot(1, type="n", xlab="", ylab="", xlim=c(0, 1), ylim=c(0, 1))
text(0.5, 0.5, "GO Biological Process, DECOY1", cex = 2.5) 
...
# "Title PAGE"
plot(1, type="n", xlab="", ylab="", xlim=c(0, 1), ylim=c(0, 1))
text(0.5, 0.5, "GO Cellular Component, DECOY1", cex = 2.5) 
...
# "Title PAGE"
plot(1, type="n", xlab="", ylab="", xlim=c(0, 1), ylim=c(0, 1))
text(0.5, 0.5, "KEGG, DECOY1_mz0.0075_0.0125", cex = 2.5) 
